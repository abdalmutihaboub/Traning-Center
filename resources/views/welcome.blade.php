...
<body>
      <div id="header" class="header" >
         <nav class="navbar navbar-expand-lg navbar-light text-capitalize">
            <div class="container">
               <a class="navbar-brand" href="#"><img src="{{asset('imgs/logo.png')}}" alt="#" width="250px" hight="100px"/></a>
         ...
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="d-block w-100" src="{{asset('imgs/1.jpg')}}" alt="slider_img">
               ...
               <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('imgs/2.jpg')}}" alt="slider_img">
                  <div class="ovarlay_slide_cont">
                     <h2>We love working</h2>
                     <h4>Maintenance service</h4>
                     <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years</p>
                ...
                <div class="carousel-item">
                  <img class="d-block w-100" src="{{asset('imgs/3.jpg')}}" alt="slider_img">
                  <div class="ovarlay_slide_cont">
                     <h2>We love working</h2>
                     <h4>Maintenance service</h4>
                     <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years</p>
            ...
            <div class="row">
               ...
               <div class="col-md-6 offset-md-1">
                  <div class="full text_align_center">
                     <img class="img-responsive" src="{{asset('imgs/books.jpg')}}" alt="#" />
                  </div>
               </div>
            </div>
         </div>
      ...
      <div id="hiw" class="hiw_section layout_padding" style="background: #1a2428;">
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-4">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/linkedin1.jpg')}}" alt="#" hight="500px" />
                  <h3 class="blog_head">Book Online</h3>
               </div>
               <div class="col-md-4">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/linkedin2.jpg')}}" alt="#" />
                  <h3 class="blog_head">Confirmation</h3>
               </div>
               <div class="col-md-4">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/linkedin3.jpg')}}" alt="#" />
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-8 service_blog">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/i1.jpg')}}" alt="#" />
                  <h3 class="blog_head">Book Online</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/i2.jpg')}}" alt="#" />
                  <h3 class="blog_head">Confirmation</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/i3.jpg')}}" alt="#" />
                  <h3 class="blog_head">Work Status</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="i{{asset('mgs/i4.jpg')}}" alt="#" />
                  <h3 class="blog_head">Work Status</h3>
               </div>
               <div class="col-md-4 service_blog">
                  <img class="margin_top_30 img-responsive" src="{{asset('imgs/i5.jpeg')}}" alt="#" />
                  <h3 class="blog_head">Work Status</h3>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-md-5 text_align_center">
                  <img class="img-responsive" src="{{asset('imgs/girl%20img.jpg')}}" alt="#" />
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               <div class="col-lg-3 col-md-6 col-12">
                  <div class="footer_blog_section">
                     <img src="{{asset('imgs/logo.png')}}" alt="#" width="250px"/>
               ...
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="item">
                     ...
                     <p><img src="{{asset('imgs/phone_icon.png')}}" alt="#" /> 1234 River Street New York, NY 36524</p>
                     <p><strong>Customer Service:</strong></p>
                     <p><img src="{{asset('imgs/location.png')}}" alt="#" /> 987 654 3210</p>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-12">
                  <div class="item">
